...
class ItemListViewController: UIViewController, UITableViewDelegate, UITableViewDataSource, UISearchBarDelegate,ItemTableViewCellDelegate, BiddingViewControllerDelegate, MFMailComposeViewControllerDelegate {
    ...
    override func viewDidLoad() {
        ...
        /*if (items.count != 0){
            ...
            let item = items[0]
            var till = (item.closeTime.relativeTime().lowercaseString)
            if till.rangeOfString("2 hours") != nil {
                println("hello mofo")
                var localNotification:UILocalNotification = UILocalNotification()
                localNotification.alertAction = "2 hours remaining!"
                localNotification.alertBody = "Come back and bid!"
    ...
    @IBAction func optionsPressed(sender: AnyObject) {
        ...
        alert.addButton("Submit Feedback"){
            var subjectText = "Habitats iOS Application Feedback"
            var toRecipient = ["mkchoi212@icloud.com"]
        ...
        alert.addButton("Share"){
            ...
            sharingItems.append("Check out the Texas A&M Habitat for Humanity app on the App Store")
            sharingItems.append("https://itunes.apple.com/us/app/habitats/id7J57M62A98?ls=1&mt=8")
            let activityViewController = UIActivityViewController(activityItems: sharingItems, applicationActivities: nil)
            self.presentViewController(activityViewController, animated: true, completion: nil)
        }
        alert.addButton("Rate on App Store"){
            var url : NSURL
            url = (NSURL(string: "https://itunes.apple.com/us/app/habitats/id7J57M62A98?ls=1&mt=8")!)
            UIApplication.sharedApplication().openURL(url)
        }
        
        alert.showInfo("Options", subTitle:"Please make a selection", closeButtonTitle: "Cancel", duration: 4)
    }
