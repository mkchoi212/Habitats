...
class ICETutorialController : UIViewController, UIScrollViewDelegate {
    ...
    func setupView() {
        ...
        self.leftButton!.setTitle("About", forState: UIControlState.Normal)
        self.rightButton!.setTitle("Log In", forState: UIControlState.Normal)
    ...
    func animateScrolling() {
        ...
        // Make the scrollView animation.
        var nextPagePosition: CGFloat = CGFloat(nextPage) * 320
    ...
    func scrollingToFirstPageWithOffset(offset: CGFloat) {
        ...
        let offsetX: CGFloat = (offset * 320)
        let numberOfPage: CGFloat = 5
        let offsetY: CGFloat = (320 * numberOfPage)
        let finalOffset: CGFloat = offsetX / offsetY
        ...
        var backLayerAlpha: CGFloat = (1 - offset)
        var frontLayerAlpha: CGFloat = offset
    ...
    func scrollingToNextPageWithOffset(offset: CGFloat) {
        ...
        var alphaValue: CGFloat = offset - CGFloat(Int(offset));
        ...
        var backLayerAlpha: CGFloat = alphaValue
        var frontLayerAlpha: CGFloat = (1 - alphaValue)
    ...
    func scrollViewDidScroll(scrollView: UIScrollView!) {
        ...
        var scrollingPosition: CGFloat = self.scrollView!.contentOffset.x / 320.0
